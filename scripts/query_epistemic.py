...
# ---------------------------------------------------------------------------
# Document resolution -- every node carries `provenance` entries and a `meta`
# fallback; a real multi-document corpus would map chunk_id -> source file,
# but only one real document (eric_decision.pdf) exists today, and the
# fixture's provenance chunk_ids are null, so this falls back to meta.
# ---------------------------------------------------------------------------
